// =========================================== 
// DUCT CALCULATOR STANDALONE
// Standalone version with personal calculations workspace
// Same workflow as hydronic calculator
// =========================================== 
...
import { DuctCalculatorCore } from './DuctCalculatorCore'
...
export function DuctCalculatorStandalone() {
  const { 
  ...
  // Fetch personal calculations on mount (filter by 'duct' type)
  useEffect(() => {
    fetchUserCalculations('duct')
  }, [fetchUserCalculations])
  ...
  useEffect(() => {
    if (isSupabaseConfigured()) {
      ...
      ;(supabase as any)
        ...
        .then(({ data }: { data: HVACProject[] | null }) => {
          if (data) setHvacProjects(data)
        })
    }
  }, [])
  
  // Fetch duct systems when current calc changes
  useEffect(() => {
    if (currentCalcId) {
  ...
  // Filter calculations to only show 'duct' type
  const ductCalculations = calculations.filter(c => c.calcType === 'duct')
  
  const handleCreateCalc = async () => {
    if (!newCalcName.trim()) return
    setIsCreating(true)
    try {
      const calc = await createCalculation(newCalcName.trim(), 'duct')
  ...
  const handleMoveToProject = async (projectId: string) => {
    ...
    try {
      // Move all duct systems to the project
      ...
      await fetchUserCalculations('duct')
    } catch (error) {
    ...
    <div className="h-full flex flex-col bg-gray-900">
        ...
        <div className="p-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-bold text-white">Duct Pressure Drop Calculator</h1>
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {showDropdown && (
                <div className="absolute top-full left-0 mt-1 w-64 bg-gray-700 rounded-lg shadow-xl border border-gray-600 z-20 overflow-hidden">
                  {ductCalculations.length === 0 ? (
                    <div className="p-3 text-sm text-gray-400 text-center">
                      No saved calculations
                    </div>
                  ) : (
                    <div className="max-h-48 overflow-auto">
                      {ductCalculations.map(calc => (
                        <button
                          key={calc.id}
                          onClick={() => {
                            setCurrentCalc(calc.id)
                  ...
                  <div className="border-t border-gray-600 p-2">
                    <button
                      ...
                      className="w-full flex items-center gap-2 px-3 py-2 text-sm text-cyan-400 hover:bg-gray-600 rounded transition-colors"
                    >
          ...
          <div className="px-4 pb-3">
            <div className="flex items-center justify-between gap-4 px-3 py-2 bg-amber-900/30 border border-amber-700/50 rounded-lg">
              ...
              <button
                ...
                className="flex items-center gap-1 px-3 py-1 bg-cyan-600 hover:bg-cyan-500 text-white text-sm rounded transition-colors"
              >
      ...
      <div className="flex-1 overflow-hidden">
        {currentCalc ? (
          ...
          <div className="flex-1 flex items-center justify-center text-gray-500 p-8 h-full">
            <div className="text-center">
              ...
              <button
                onClick={() => setShowNewCalcModal(true)}
                className="px-4 py-2 bg-cyan-600 hover:bg-cyan-500 rounded-lg transition-colors text-white"
              >
          ...
          <div className="bg-gray-800 rounded-xl shadow-xl w-96 overflow-hidden">
            ...
            <div className="p-4">
              ...
              <input
                ...
                placeholder="e.g., AHU-1 Supply System"
            ...
            <div className="p-4 border-t border-gray-700 flex justify-end gap-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-cyan-600 hover:bg-cyan-500 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-lg transition-colors"
              >
          ...
          <div className="bg-gray-800 rounded-xl shadow-xl w-96 overflow-hidden">
            ...
            <div className="p-4">
              ...
              <p className="text-sm text-gray-500 mt-2">
                This will delete all {systemsForCurrentCalc.length} duct system(s) in this calculation.
              </p>
            </div>
            <div className="p-4 border-t border-gray-700 flex justify-end gap-2">
              <button
          ...
          <div className="bg-gray-800 rounded-xl shadow-xl w-[450px] overflow-hidden">
            <div className="p-4 border-b border-gray-700">
              ...
              <p className="text-sm text-gray-400 mt-1">
                Move all duct systems from "{currentCalc?.name}" to a project. The calculation will appear in the project's Calculators tab.
              </p>
            </div>
